...
public class KTableKTableOneToManyJoinTest {
    ...
    private void doTestJoin(final StreamsBuilder builder,
        ...
        processor.checkAndClearProcessResult("5:value1=1,5,YYYY,value2=1,X", "6:value1=1,6,YYYY,value2=1,X", "7:value1=1,7,YYYY,value2=1,X");
        ...
        processor.checkAndClearProcessResult("5:value1=1,5,YYYY,value2=1,XYZ", "6:value1=1,6,YYYY,value2=1,XYZ", "7:value1=1,7,YYYY,value2=1,XYZ");
