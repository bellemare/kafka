...
public class KStreamCogroupProcessorSupplier<K, V> implements KStreamAggProcessorSupplier<K, K, Change<V>, V> {
    private final List<KStreamAggProcessorSupplier> parents;
    private boolean sendOldValues = false;
    public KStreamCogroupProcessorSupplier(Collection<KStreamAggProcessorSupplier> parents) {
