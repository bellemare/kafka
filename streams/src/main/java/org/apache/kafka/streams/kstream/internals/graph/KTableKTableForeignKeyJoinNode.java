...
public class KTableKTableForeignKeyJoinNode<VR, K, V, KO, VO> extends StreamsGraphNode {
    ...
    private final String repartitionSinkName;
    private final String repartitionSourceName;
    private final ProcessorParameters repartitionProcessorParameters;
    ...
    private final CombinedKeyByForeignKeyPartitioner<KO, K, V> partitioner;
