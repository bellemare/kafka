 ...
 */
public class KTableKTableForeignKeyJoinNode<K, V1, V2, VR> extends BaseJoinProcessorNode<K, V1, V2, VR> {
    ...
    KTableKTableForeignKeyJoinNode(final String nodeName,
    ...
    public static final class KTableKTableJoinNodeBuilder<K, V1, V2, VR> {
        ...
        public KTableKTableForeignKeyJoinNode<K, V1, V2, VR> build() {

            return new KTableKTableForeignKeyJoinNode<>(nodeName,
                                              valueJoiner,
                                              joinThisProcessorParameters,
                                              joinOtherProcessorParameters,
                                              joinMergeProcessorParameters,
